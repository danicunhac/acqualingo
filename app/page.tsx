      ...
      <div className="flex flex-col z-10 w-full items-center justify-between text-sm bg-white/10 backdrop-blur-sm rounded-lg pt-5 px-20 pb-20 gap-8 w-full">
        ...
        <div className="flex">
          <div className="w-full flex flex-col gap-y-8 max-w-[900px]">
            ...
            <button
              type="button"
              className="uppercase transition-colors text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
            >
              Start
            </button>
          </div>
        ...
        >
          ...
          <div className="flex text-2xl gap-12 mt-12">
            ...
            <p>
              And as you may know, <span className="text-[#4A89DC]">water</span>{' '}
              is <span className="text-[#5DD2CE]">crucial</span> for human
              being, so you don&apos;t want to{' '}
